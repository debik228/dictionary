...
public class Program {
    ...
    public static void main(String[] args) throws Exception{
        ...
        var conn = Common.getConn();
        var stat = conn.createStatement();

        engWords = Common.loadWordTable(stat, Tables.eng_words);
        ukrWords = Common.loadWordTable(stat, Tables.ukr_words);
    ...
    public static void train(Statement stmt) throws IOException{
        var user = new ConfigFile("C:\\Users\\Yevgen\\Desktop\\pogromyvannja\\JAVA\\Dictionary\\user.txt");
        boolean lastTrainWasToday = isToday(user.params.get("last_training"));
